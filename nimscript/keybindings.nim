...
bindKey({Ctrl,R}, Action.Run)
bindKey({Ctrl,E}, Action.Exec)
bindKey({Ctrl,G}, Action.Goto)
bindKey({Ctrl,F}, Action.Find)
bindKey({Ctrl,H}, Action.Replace)
...
bindKey({F2}, Action.GotoDefinition)
