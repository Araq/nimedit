...
proc initWinapiDriver*() =
  setDpiAware()
  # Screen hooks
  createWindowHook = winCreateWindow
  refreshHook = winRefresh
  saveStateHook = winSaveState
  restoreStateHook = winRestoreState
  setClipRectHook = winSetClipRect
  openFontHook = winOpenFont
  closeFontHook = winCloseFont
  measureTextHook = winMeasureText
  drawTextHook = winDrawText
  getFontMetricsHook = winGetFontMetrics
  fillRectHook = winFillRect
  drawLineHook = winDrawLine
  drawPointHook = winDrawPoint
  setCursorHook = winSetCursor
  setWindowTitleHook = winSetWindowTitle
  # Input hooks
  pollEventHook = winPollEvent
  waitEventHook = winWaitEvent
  getClipboardTextHook = winGetClipboardText
  putClipboardTextHook = winPutClipboardText
  getModStateHook = winGetModState
  getTicksHook = winGetTicks
  delayHook = winDelay
  startTextInputHook = winStartTextInput
  quitRequestHook = winQuitRequest
